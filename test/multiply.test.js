...
describe('multiply function', () => {
  ...
  test('should handle object inputs', () => {
    ...
    expect(multiply(3, {valueOf: () => 5})).toBe(15);
  });
  ...
  // Precision tests
  test('should maintain precision for small decimals', () => {
  ...
  test('should handle very small numbers', () => {
    ...
    expect(multiply(Number.MIN_VALUE, 2)).toBeCloseTo(Number.MIN_VALUE * 2);
  });
